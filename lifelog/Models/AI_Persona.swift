...
enum AI_Persona: String, CaseIterable, Identifiable {
    ...
    var displayName: String {
        switch self {
        case .counselor: return String(localized: "🌸 寄り添いカウンセラー")
        case .coach: return String(localized: "🔥 鬼コーチ")
        case .highlight: return String(localized: "✨ 月間ハイライト")
        case .tsundere: return String(localized: "😼 ツンデレ幼馴染")
        case .detective: return String(localized: "🕵️‍♂️ 名探偵")
        case .fortune: return String(localized: "🔮 謎の占い師")
        case .butler: return String(localized: "👑 執事")
        case .cat: return String(localized: "🐱 気まぐれな猫")
        }
    }
    ...
    var shortDescription: String {
        switch self {
        case .counselor: return String(localized: "優しく肯定し、小さな頑張りを褒めてくれます。")
        case .coach: return String(localized: "甘えを許さず、事実に基づいて厳しく指導します。")
        case .highlight: return String(localized: "良いことだけを抽出して、最高の思い出にします。")
        case .tsundere: return String(localized: "素直になれない幼馴染。口は悪いですが心配してくれます。")
        case .detective: return String(localized: "生活の謎を論理的に推理します。")
        case .fortune: return String(localized: "運勢として診断し、神秘的なアドバイスをくれます。")
        case .butler: return String(localized: "あなたを主と仰ぎ、全肯定で労います。")
        case .cat: return String(localized: "気まぐれな猫視点で、癒やしのアドバイスをくれます。")
        }
    }
